...
import ru.mp3downloader.config.EmailSenderConfig;
...
@SpringBootTest(classes = {EmailSenderConfig.class, EmailServiceImpl.class})
public class EmailTest {
    ...
    public void testEmailWithFile() throws MessagingException, IOException {
        ...
        File file = new File(this.getClass().getClassLoader().getResource("TextFile.txt").getFile());
        ...
        assertEquals(bodyPart.getFileName(), "TextFile.txt");
